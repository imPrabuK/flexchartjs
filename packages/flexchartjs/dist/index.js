...
function LineChart({ option, width = "100%", height = "100%", className }) {
  const { seriesData, xLabels, minY, maxY } = (0, import_react.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className, style: { width, height, backgroundColor: option?.backgroundColor || "transparent" }, children: !seriesData.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex h-full items-center justify-center text-xs text-slate-400", children: "No data to display" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { viewBox: "0 0 600 300", className: "h-full w-full", preserveAspectRatio: "xMidYMid meet", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "40", x2: "560", y1: "260", y2: "260", stroke: "#e5e7eb", strokeWidth: "1" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "40", x2: "40", y1: "40", y2: "260", stroke: "#e5e7eb", strokeWidth: "1" }),
    Array.from({ length: 5 }).map((_, i) => {
      const y = 260 - i * (220 / 4);
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: "35", x2: "560", y1: y, y2: y, stroke: "#f3f4f6", strokeWidth: "1", strokeDasharray: "4 4" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: "30", y: y + 4, textAnchor: "end", fontSize: "10", fill: "#9ca3af", children: Math.round(minY + i * (maxY - minY) / 4) })
      ] }, i);
    }),
    seriesData.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
      s.areaStyle && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "polygon",
        {
      ...
      s.symbol !== "none" && s.points.map((p, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "circle",
        {
          cx: p.x,
          cy: p.y,
    ...
    xLabels.map((label, idx) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x, y: "280", textAnchor: "middle", fontSize: "10", fill: "#6b7280", children: label }, idx);
    })
  ] }) });
}
...
function BarChart({ option, width = "100%", height = "100%", className }) {
  const { seriesData, xLabels, minY, maxY } = (0, import_react2.useMemo)(() => {
    if (!option?.xAxis?.data && !option?.series) {
      return { seriesData: [], xLabels: [], minY: 0, maxY: 0 };
    }
    const xLabels2 = option?.xAxis?.data || [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className, style: { width, height, backgroundColor: option?.backgroundColor || "transparent" }, children: !seriesData.length ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex h-full items-center justify-center text-xs text-slate-400", children: "No data to display" }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { viewBox: "0 0 600 300", className: "h-full w-full", preserveAspectRatio: "xMidYMid meet", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: "40", x2: "560", y1: "260", y2: "260", stroke: "#e5e7eb", strokeWidth: "1" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: "40", x2: "40", y1: "40", y2: "260", stroke: "#e5e7eb", strokeWidth: "1" }),
    Array.from({ length: 5 }).map((_, i) => {
      const y = 260 - i * (220 / 4);
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("line", { x1: "35", x2: "560", y1: y, y2: y, stroke: "#f3f4f6", strokeWidth: "1", strokeDasharray: "4 4" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("text", { x: "30", y: y + 4, textAnchor: "end", fontSize: "10", fill: "#9ca3af", children: Math.round(minY + i * (maxY - minY) / 4) })
      ] }, i);
    }),
    seriesData.map((s, sIdx) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("g", { children: s.bars.map((bar, idx) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      "rect",
      {
        x: bar.x,
        y: bar.y,
    ...
    xLabels.map((label, idx) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("text", { x, y: "280", textAnchor: "middle", fontSize: "10", fill: "#6b7280", children: label }, idx);
    })
  ] }) });
}
...
function PieChart({ option, width = "100%", height = "100%", className }) {
  const { slices, title } = (0, import_react3.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className, style: { width, height, backgroundColor: option?.backgroundColor || "transparent" }, children: !slices.length ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex h-full items-center justify-center text-xs text-slate-400", children: "No data to display" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { viewBox: "0 0 400 300", className: "h-full w-full", preserveAspectRatio: "xMidYMid meet", children: [
    title && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("text", { x: "200", y: "30", textAnchor: "middle", fontSize: "14", fontWeight: "bold", fill: option?.title?.textStyle?.color || "#374151", children: title }),
    slices.map((slice, idx) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("g", { children: [
      ...
      slice.value > 0 && slice.label?.show !== false && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "text",
        {
          x: slice.centroid.x,
          y: slice.centroid.y,
