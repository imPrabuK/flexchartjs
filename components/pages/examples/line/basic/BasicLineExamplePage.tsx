...
function parseOption(code: string): OptionLike | null {
    try {
        // Execute user code in a sandboxed function and return `option`
...
function LinePreview({ option }: { option: OptionLike | null }) {
...
export default function BasicLineExamplePage() {
    ...
    return (
        <div className="w-full min-h-screen bg-slate-50 pt-24">
                ...
                <div className="grid gap-4 md:grid-cols-[minmax(0,1.15fr)_minmax(0,1.35fr)]">
                    ...
                    <section className="flex flex-col rounded-xl border border-slate-200 bg-white p-4">
                        ...
                        <div className="flex-1 rounded-lg bg-slate-50 p-4">
                            <LinePreview option={renderedOption} />
                        </div>
